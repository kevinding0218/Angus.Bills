...
namespace Angus.Bills.WebApi.Security
{
    public static class Extensions
    {
        ...
        public static IAngusBillsBuilder AddCertificateAuthentication(this IAngusBillsBuilder builder,
            string sectionName = SectionName, Type permissionValidatorType = null)
        {
            ...
            if (options.Certificate is null || !options.Certificate.Enabled) return builder;
        ...
        public static IApplicationBuilder UseCertificateAuthentication(this IApplicationBuilder app)
        {
            ...
            if (options.Certificate is null || !options.Certificate.Enabled) return app;
