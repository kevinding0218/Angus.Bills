...
namespace Angus.Bills.Docs.Swagger
{
    public static class Extensions
    {
        ...
        public static IAngusBillsBuilder AddSwaggerDocs(this IAngusBillsBuilder builder,
        ...
        public static IAngusBillsBuilder AddSwaggerDocs(this IAngusBillsBuilder builder, SwaggerOptions options)
        {
