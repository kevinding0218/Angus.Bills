using System;
using Angus.Bills.Discovery.Consul.Builders;
using Angus.Bills.Discovery.Consul.Http;
using Angus.Bills.Discovery.Consul.MessageHandlers;
using Angus.Bills.Discovery.Consul.Models;
using Angus.Bills.Discovery.Consul.Services;
...
namespace Angus.Bills.Discovery.Consul
{
    public static class Extensions
    {
        ...
        public static IAngusBillsBuilder AddConsul(this IAngusBillsBuilder builder, string sectionName = SectionName,
        ...
        public static IAngusBillsBuilder AddConsul(this IAngusBillsBuilder builder,
        ...
        public static IAngusBillsBuilder AddConsul(this IAngusBillsBuilder builder, ConsulOptions options,
            HttpClientOptions httpClientOptions)
        {
            ...
            if (registration is null) return builder;
        ...
        public static void AddConsulHttpClient(this IAngusBillsBuilder builder, string clientName, string serviceName)
        {
        ...
        private static ServiceRegistration CreateConsulAgentRegistration(this IAngusBillsBuilder builder,
            ConsulOptions options)
        {
            var enabled = options.Enabled;
            var consulEnabled = Environment.GetEnvironmentVariable("CONSUL_ENABLED")?.ToLowerInvariant();
            if (!string.IsNullOrWhiteSpace(consulEnabled)) enabled = consulEnabled == "true" || consulEnabled == "1";
            ...
            if (!options.PingEnabled) return registration;
            ...
            if (pingEndpoint.EndsWith("/")) pingEndpoint = pingEndpoint.Substring(0, pingEndpoint.Length - 1);
        ...
        {
            if (string.IsNullOrWhiteSpace(value)) return DefaultInterval;
