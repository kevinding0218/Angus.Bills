...
using Angus.Bills.LoadBalancing.Fabio;
...
namespace Angus.Bills.HTTP.RestEase
{
    public static class Extensions
    {
        ...
        public static IAngusBillsBuilder AddServiceClient<T>(this IAngusBillsBuilder builder, string serviceName,
        ...
        private static IAngusBillsBuilder AddServiceClient<T>(this IAngusBillsBuilder builder, string serviceName,
            RestEaseOptions options, Action<IAngusBillsBuilder> registerFabio)
            where T : class
        {
