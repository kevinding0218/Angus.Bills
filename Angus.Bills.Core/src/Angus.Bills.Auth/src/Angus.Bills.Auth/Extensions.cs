...
using System.Text;
using Angus.Bills.Auth.Handlers;
using Angus.Bills.Auth.Services;
...
namespace Angus.Bills.Auth
{
    public static class Extensions
    {
        ...
        public static IAngusBillsBuilder AddJwt(this IAngusBillsBuilder builder, string sectionName = SectionName,
        ...
        private static IAngusBillsBuilder AddJwt(this IAngusBillsBuilder builder, JwtOptions options,
            Action<JwtBearerOptions> optionsFactory = null)
        {
