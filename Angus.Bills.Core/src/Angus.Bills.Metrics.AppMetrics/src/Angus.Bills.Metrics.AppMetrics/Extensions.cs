...
using Angus.Bills.Metrics.AppMetrics.Builders;
using App.Metrics;
...
namespace Angus.Bills.Metrics.AppMetrics
{
    public static class Extensions
    {
        ...
        public static IAngusBillsBuilder AddMetrics(this IAngusBillsBuilder builder,
        ...
        public static IAngusBillsBuilder AddMetrics(this IAngusBillsBuilder builder, MetricsOptions metricsOptions,
            AppOptions appOptions)
        {
            builder.Services.AddSingleton(metricsOptions);
            if (!builder.TryRegister(RegistryName) || !metricsOptions.Enabled || _initialized) return builder;
