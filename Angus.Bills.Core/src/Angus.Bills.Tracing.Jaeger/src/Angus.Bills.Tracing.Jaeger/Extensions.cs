...
using Angus.Bills.Tracing.Jaeger.Builders;
using Angus.Bills.Tracing.Jaeger.Middlewares;
using Angus.Bills.Tracing.Jaeger.Tracers;
using Jaeger;
...
namespace Angus.Bills.Tracing.Jaeger
{
    public static class Extensions
    {
        ...
        public static IAngusBillsBuilder AddJaeger(this IAngusBillsBuilder builder, string sectionName = SectionName)
        {
        ...
        public static IAngusBillsBuilder AddJaeger(this IAngusBillsBuilder builder,
        ...
        public static IAngusBillsBuilder AddJaeger(this IAngusBillsBuilder builder, JaegerOptions options)
        {
            if (Interlocked.Exchange(ref _initialized, 1) == 1) return builder;
