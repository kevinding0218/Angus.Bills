...
namespace Angus.Bills.MessageBrokers.RawRabbit.Registers
{
    internal sealed class RabbitMqPluginRegister : IRabbitMqPluginRegister
    {
        private readonly List<(Action<IClientBuilder> buildClient, Action<IDependencyRegister>registerDependencies)>
            _plugins =
