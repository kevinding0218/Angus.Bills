...
using Angus.Bills.MessageBrokers.RawRabbit.Builders;
using Angus.Bills.MessageBrokers.RawRabbit.Processors;
using Angus.Bills.MessageBrokers.RawRabbit.Publishers;
using Angus.Bills.MessageBrokers.RawRabbit.Registers;
using Angus.Bills.MessageBrokers.RawRabbit.Subscribers;
using Angus.Bills.Persistence.Redis;
...
namespace Angus.Bills.MessageBrokers.RawRabbit
{
    public static class Extensions
    {
        ...
        public static IAngusBillsBuilder AddRabbitMq<TContext>(this IAngusBillsBuilder builder,
        ...
        public static IAngusBillsBuilder AddRabbitMq<TContext>(this IAngusBillsBuilder builder, RabbitMqOptions options,
            Func<IRabbitMqPluginRegister, IRabbitMqPluginRegister> plugins = null,
        ...
        private static IAngusBillsBuilder AddRabbitMq<TContext>(this IAngusBillsBuilder builder,
            RabbitMqOptions options,
            Func<IRabbitMqPluginRegister, IRabbitMqPluginRegister> plugins, Action<IAngusBillsBuilder> registerRedis)
            where TContext : class, new()
        {
        ...
        private static void ConfigureBus<TContext>(IAngusBillsBuilder builder,
            Func<IRabbitMqPluginRegister, IRabbitMqPluginRegister> plugins = null)
            where TContext : class, new()
        {
