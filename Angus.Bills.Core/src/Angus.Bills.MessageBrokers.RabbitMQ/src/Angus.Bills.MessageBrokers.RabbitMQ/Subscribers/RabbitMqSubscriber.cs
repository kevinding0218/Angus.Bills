...
namespace Angus.Bills.MessageBrokers.RabbitMQ.Subscribers
{
            ...
            where T : class
        {
            ...
            consumer.Received += async (model, args) =>
            {
                ...
                try
                {
                    ...
                    {
                        return TryHandleAsync((T) m, messageId, correlationId, ctx, a, handle);
                    }
            ...
            await retryPolicy.ExecuteAsync(async () =>
            {
                ...
                catch (Exception ex)
                {
                    ...
                    if (rejectedEvent is null)
                    {
                        ...
                        if (currentRetry > 1) _logger.LogError(errorMessage);

                        if (currentRetry - 1 < _retries) throw new Exception(errorMessage, ex);
