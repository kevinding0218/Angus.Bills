...
{
    internal sealed class AngusBillsLoggingScopeHttpMessageHandler : DelegatingHandler
    {
        private readonly ILogger _logger;
        private readonly HashSet<string> _maskedRequestUrlParts;
        private readonly string _maskTemplate;

        public AngusBillsLoggingScopeHttpMessageHandler(ILogger logger, HttpClientOptions options)
        {
