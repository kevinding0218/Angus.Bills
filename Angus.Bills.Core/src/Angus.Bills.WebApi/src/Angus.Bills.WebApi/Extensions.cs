...
using Angus.Bills.WebApi.Exceptions;
using Angus.Bills.WebApi.Formatters;
using Angus.Bills.WebApi.Requests;
...
namespace Angus.Bills.WebApi
{
    public static class Extensions
    {
        ...
        [Description(
            "By default Newtonsoft JSON serializer is being used and it sets Kestrel's and IIS ServerOptions AllowSynchronousIO = true")]
        public static IAngusBillsBuilder AddWebApi(this IAngusBillsBuilder builder,
        ...
        public static IAngusBillsBuilder AddErrorHandler<T>(this IAngusBillsBuilder builder)
