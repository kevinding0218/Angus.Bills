using System;
using Drex.Discovery.Consul.Builders;
using Drex.Discovery.Consul.Http;
using Drex.Discovery.Consul.MessageHandlers;
using Drex.Discovery.Consul.Models;
using Drex.Discovery.Consul.Services;
...
namespace Drex.Discovery.Consul
{
    public static class Extensions
    {
        ...
        private static ServiceRegistration CreateConsulAgentRegistration(this IDrexBuilder builder,
