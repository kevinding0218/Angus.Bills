...
namespace Drex.Discovery.Consul.Services
{
    internal sealed class ConsulHostedService : IHostedService
    {
        ...
        public async Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            _logger.LogError(
                $"There was an error when registering a service [id: {registration.Id}] in Consul. {response}");
        }
        ...
        public async Task StopAsync(CancellationToken cancellationToken)
        {
            ...
            _logger.LogError(
                $"There was an error when deregistering a service [id: {registration.Id}] from Consul. {response}");
        }
    }
}