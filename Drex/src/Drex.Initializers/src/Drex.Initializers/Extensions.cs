...
namespace Drex.Initializers
{
    public static class Extensions
    {
        ...
        public static IDrexBuilder AddDrexCore(this IServiceCollection services,
            string sectionName = SectionName)
        {
            if (string.IsNullOrWhiteSpace(sectionName)) sectionName = SectionName;

            var builder = DrexBuilder.Create(services);
            ...
            Console.WriteLine($"IDrexBuilder: {options.Name}{version}");

            return builder;
        }

        public static IApplicationBuilder UseDrexCore(this IApplicationBuilder app)
        {
