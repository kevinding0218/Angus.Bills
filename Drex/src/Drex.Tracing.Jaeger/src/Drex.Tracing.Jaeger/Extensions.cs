...
using Drex.Tracing.Jaeger.Builders;
using Drex.Tracing.Jaeger.Middlewares;
using Drex.Tracing.Jaeger.Tracers;
using Jaeger;
...
namespace Drex.Tracing.Jaeger
{
    public static class Extensions
    {
        ...
        public static IDrexBuilder AddJaeger(this IDrexBuilder builder, string sectionName = SectionName)
        {
        ...
        public static IDrexBuilder AddJaeger(this IDrexBuilder builder,
        ...
        public static IDrexBuilder AddJaeger(this IDrexBuilder builder, JaegerOptions options)
        {
