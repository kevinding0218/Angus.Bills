...
using Drex.LoadBalancing.Fabio.Builders;
using Drex.LoadBalancing.Fabio.Http;
using Drex.LoadBalancing.Fabio.MessageHandlers;
...
namespace Drex.LoadBalancing.Fabio
{
    public static class Extensions
    {
        ...
        public static void AddFabioHttpClient(this IDrexBuilder builder, string clientName, string serviceName)
        {
